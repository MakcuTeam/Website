...
Welcome to **Makcu**! This template provides a modern, flexible, and user-friendly foundation for creating engaging guide. Whether you're building a knowledge base, project docs, or a personal blog, Makcu makes it easy to set up and scale.


##  Open Source Philosophy

Makcu is proudly **open-source**! 🎉 We believe in creating an accessible, collaborative platform that thrives on community contributions.
...
**Makcu** is more than just a guide template. It's a **complete toolkit** designed for modern web development. Key features include:

- **Markdown & MDX Support:** Easily write guide in Markdown, with the option to include interactive components via MDX.
...
Makcu leverages cutting-edge technologies to ensure performance and flexibility:
