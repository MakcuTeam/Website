## Makcu - guide Template

This feature-packed guide template, built with Next.js, offers a sleek and responsive design, perfect for all your project guide needs.

<br/>

### Quick Start

You can create a new Makcu project using the command:
...
```
Creating a new Makcu project in /path/to/your/project from the master branch...
Cloning Master (Full guide)...
Makcu project successfully created in /path/to/your/project!
...
Check out our [Next.js deployment guide](https://nextjs.org/docs/deployment) for more details.
...
| **Feature**                   | **Description**                                          |
|-------------------------------|----------------------------------------------------------|
| MDX Support                   | Write interactive guide with MDX.                |
