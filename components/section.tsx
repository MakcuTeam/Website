  ...
  return (
    <section id={id} className="scroll-mt-28">
      <div className="space-y-4">
        <h2 className="text-3xl font-semibold tracking-tight lg:text-4xl text-stone-800 dark:text-foreground">{title}</h2>
...
export function SubSection({ id, title, description, children }: SubSectionProps) {
  return (
    <section id={id} className="scroll-mt-28 space-y-4">
      <h3 className="text-xl font-semibold tracking-tight lg:text-2xl text-stone-800 dark:text-foreground">{title}</h3>
      {description ? (
