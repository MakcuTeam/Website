                  ...
                  },
                  {
                    ...
                    content: isCn ? (
                      <div className="space-y-3">
                        ...
                        <ul className="list-disc space-y-2 pl-5">
                          <li><strong>115k</strong> (115200 bps)</li>
                          <li><strong>400 万</strong> (4,000,000 bps)</li>
                        </ul>
                        <p className="font-semibold">命令时序：</p>
                        <p>
                          命令 <span className="font-mono">km.move(100,100)\r</span> 总共 17 字节。
                        </p>
                        <ul className="list-disc space-y-1 pl-5 text-xs">
                          <li>在 115k 下，传输约需 <strong>1.48ms</strong></li>
                          <li>在 400 万下，传输约需 <strong>42.5µs</strong></li>
                        </ul>
                        ...
                        <Tip>
                          <p className="font-semibold">忽略 Windows 波特率设置</p>
                          <p>
                      ...
                      <div className="space-y-3">
                        <p>
                          MAKCU supports two baud rates:
                        </p>
                        <ul className="list-disc space-y-2 pl-5">
                          <li><strong>115k</strong> (115200 bps)</li>
                          <li><strong>4 million</strong> (4,000,000 bps)</li>
                        </ul>
                        <p className="font-semibold">Command Timing:</p>
                        <p>
                          The command <span className="font-mono">km.move(100,100)\r</span> is 17 bytes total.
                        </p>
                        <ul className="list-disc space-y-1 pl-5 text-xs">
                          <li>At 115k, this takes approx <strong>1.48ms</strong> to transmit.</li>
                          <li>At 4m, this takes approx <strong>42.5µs</strong> to transmit.</li>
                        </ul>
                        ...
                        <Tip>
                          <p className="font-semibold">Ignore Windows Baud Rate Settings</p>
                          <p>
