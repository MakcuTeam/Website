...
export default {
  "metadata": {
    "title": "Makcu Official",
    "description": "Experience seamless mouse and keyboard control with MAKCU, the next generation KMBOX replacement."
  },
  "home": {
    "tips": "The Future of hardware aiming",
    "main_header": "Experience security and speed with the next generation KMBOX killer.",
  ...
  "info": {
    ...
    "list": [
      ...
      },
      {
        ...
        "number": "Almost all",
        "description": "We are actively adapting to all mice and believe that 100% coverage will be achieved soon."
      },
      {
        "icon": "cpu",
  ...
  "blog": {
    ...
    "sub_title": "All the latest blogs and news, straight from the team.",
